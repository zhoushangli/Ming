...
public:
    ...
    void DrawVertexArray(int numVertexes, Vertex_PCUTBN const *vertexes) const;
    
    void DrawVertexArray(std::vector<Vertex_PCUTBN> const &verts) const;
    void DrawVertexArray(std::vector<Vertex_PCUTBN> const &verts, std::vector<unsigned int> const &vertIndexs) const;
