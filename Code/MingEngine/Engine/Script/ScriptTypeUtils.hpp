...
std::string BuildBridgeFunctionName(MethodInfo const& methodInfo, bool isGlobalObject = false);
std::string BuildGlobalBridgeFunctionName(MethodInfo const& methodInfo);
std::string BuildBridgeFunctionDeclaration(MethodInfo const& methodInfo, bool isGlobalObject = false);
