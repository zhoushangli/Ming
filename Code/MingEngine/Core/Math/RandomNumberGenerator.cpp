...
float RandomNumberGenerator::RollRandomFloatZeroToOne() { return (float)((float)std::rand() / float(RAND_MAX)); }
...
Vector2 RandomNumberGenerator::RollRandomVec2InRange(float min, float max)
{
	Vector2 output;
...
Vector2 RandomNumberGenerator::RollRandomVec2InRange(Vector2 leftBottom, Vector2 rightTop)
{
	Vector2 output;
...
Vector2 RandomNumberGenerator::RollRandomVec2InRange(float minX, float maxX, float minY, float maxY)
{
	Vector2 output;
